...
<div class="dic">
	...
	<thead>
		<tr><th style="display: none;">glosario</th></tr>
	</thead>
		<tr>
			<td>		
			<h3>A</h3> 
	...
	<a href="{{ asset('/cenepred/docs/glosario-terminos-grd-cenepred.pdf') }}" target="_blank" class="btn btn-info"> <span class="glyphicon glyphicon-download"></span>Descargar aqui</a> 
	<div></div>
</div>
